...
tmp.add(t);
      ...
      if (jj_2_19(1) && (this.isRequirement(RequireKey.TYPING))) {
...
// To keep compatibility with PDDL 3.0: if no type is set it is number
  ...
  final public List<Symbol> function_type() throws ParseException {Token token;
    ...
    if (jj_2_25(2) && (this.isRequirement(RequireKey.NUMERIC_FLUENTS)
...
typesList.add(new Symbol(Symbol.Kind.TYPE, token));
    ...
    } else if (jj_2_26(2) && ((this.isRequirement(RequireKey.TYPING) && this.isRequirement(RequireKey.OBJECT_FLUENTS))
                                        || this.isRequirement(RequireKey.FLUENTS))) {
      typesList = type();
{if ("" != null) return typesList;}
    } else {
...
Exp n1 = new Exp(Connective.NUMBER);
  ...
  final public Exp node() throws ParseException {Exp node = null;
    if (jj_2_40(2)) {
      ...
      node = and_gd();
    } else if (jj_2_42(2) && (this.isRequirement(RequireKey.DISJUNCTIVE_PRECONDITIONS))) {
      node = or_gd();
    } else if (jj_2_43(2) && (this.isRequirement(RequireKey.NEGATIVE_PRECONDITIONS))) {
      node = not_gd();
    } else if (jj_2_44(2) && (this.isRequirement(RequireKey.DISJUNCTIVE_PRECONDITIONS)
                                    && this.isRequirement(RequireKey.NEGATIVE_PRECONDITIONS))) {
      node = imply_gd();
    } else if (jj_2_45(2) && (this.isRequirement(RequireKey.EXISTENTIAL_PRECONDITIONS))) {
      node = exists_gd();
    } else if (jj_2_46(2) && (this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS))) {
      node = forall_gd();
    } else if (jj_2_47(3) && (this.isRequirement(RequireKey.EQUALITY))) {
      node = equal_gd();
    } else if (jj_2_48(2) && (this.isRequirement(RequireKey.FLUENTS)
                            || this.isRequirement(RequireKey.NUMERIC_FLUENTS)
                            || this.isRequirement(RequireKey.OBJECT_FLUENTS))) {
      node = f_comp();
    } else {
...
this.domain.addOperator(op);
    } else if (jj_2_70(2) && (this.isRequirement(RequireKey.DURATIVE_ACTIONS))) {
      op = durative_action_def();
this.domain.addOperator(op);
    } else if (jj_2_71(2) && (this.isRequirement(RequireKey.DERIVED_PREDICATES))) {
      dp = derived_def();
...
{if ("" != null) return new Symbol(Symbol.Kind.ACTION, t);}
  ...
  final public Exp pre_gd() throws ParseException {Exp node = null;
    if (jj_2_72(3) && (this.isRequirement(RequireKey.PREFERENCES))) {
      node = pref_gd();
    } else if (jj_2_73(2)) {
      node = and_pre_gd();
    } else if (jj_2_74(2) && (this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS))) {
      node = forall_pre_gd();
    } else if (jj_2_75(2)) {
      node = empty_or();
    } else if (jj_2_76(2)) {
...
{if ("" != null) return node;}
  ...
  final public Exp c_effect() throws ParseException {Exp node = null;
    if (jj_2_81(2) && (this.isRequirement(RequireKey.CONDITIONAL_EFFECTS))) {
      node = forall_effect();
    } else if (jj_2_82(2) && (this.isRequirement(RequireKey.CONDITIONAL_EFFECTS))) {
...
{if ("" != null) return node;}
  ...
  final public Exp p_effect() throws ParseException {Exp node = null;
    if (jj_2_87(2) && (this.isRequirement(RequireKey.FLUENTS)
                            || this.isRequirement(RequireKey.NUMERIC_FLUENTS)
                            || this.isRequirement(RequireKey.OBJECT_FLUENTS))) {
      node = assign_op();
    } else if (jj_2_88(2) && (this.isRequirement(RequireKey.ACTION_COSTS))) {
...
node.addChild(child);
  ...
  final public Exp d_op() throws ParseException {Exp node = null;
    if (jj_2_104(2)) {
      node = equal_d_op();
    } else if (jj_2_105(2) && (this.isRequirement(RequireKey.DURATION_INEQUALITIES))) {
      node = gequal_d_op();
...
node.setVariable(new Symbol(Symbol.Kind.DURATION_VARIABLE, t));
  ...
  final public Exp d_value() throws ParseException {Exp node = null;
    if (jj_2_107(2)) {
      node = number();
    } else if (jj_2_108(2) && (this.isRequirement(RequireKey.FLUENTS)
                            || this.isRequirement(RequireKey.NUMERIC_FLUENTS)
                            || this.isRequirement(RequireKey.OBJECT_FLUENTS))) {
      node = f_exp();
    } else {
...
{if ("" != null) return node;}
  ...
  final public Exp da_gd() throws ParseException {Exp node = null;
    if (jj_2_109(2)) {
      ...
      node = and_da_gd();
    } else if (jj_2_111(2) && (this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS))) {
      node = forall_da_gd();
    } else {
      jj_consume_token(-1);
      throw new ParseException();
...
{if ("" != null) return node;}
  ...
  final public Exp pref_timed_gd() throws ParseException {Exp node = null;
    if (jj_2_113(2)) {
      node = timed_gd();
    } else if (jj_2_114(2) && (this.isRequirement(RequireKey.PREFERENCES))) {
...
node.addChild(child);
  ...
  final public Exp da_effect() throws ParseException {Exp node = null;
    if (jj_2_119(2)) {
      ...
      node = timed_effect();
    } else if (jj_2_121(2) && (this.isRequirement(RequireKey.CONDITIONAL_EFFECTS))) {
...
{if ("" != null) return node;}
  ...
  final public Exp timed_effect() throws ParseException {Exp node = null;
    if (jj_2_140(2)) {
      node = at_a_effect();
    } else if (jj_2_141(3) && (this.isRequirement(RequireKey.CONTINOUS_EFFECTS))) {
      node = assign_op_t();
    } else {
      jj_consume_token(-1);
      throw new ParseException();
...
{if ("" != null) return node;}
  ...
  final public Exp f_exp_da() throws ParseException {Exp node = null;
    if (jj_2_160(2)) {
      node = da_op();
    } else if (jj_2_161(2) && (this.isRequirement(RequireKey.DURATION_INEQUALITIES))) {
      node = var_duration();
    } else if (jj_2_162(2)) {
      node = f_exp();
    } else {
...
this.problem = new Problem(name);
      ...
      init();
      goal();
      if (jj_2_179(2) && (this.isRequirement(RequireKey.CONSTRAINTS))) {
        constraints(Lexer.PROBLEM);
      } else {
        ;
      }
...
this.error(e, token.beginLine, token.beginColumn);
  ...
  final public Exp init_el() throws ParseException {Exp node = null;
    if (jj_2_182(3) && (this.isRequirement(RequireKey.TIMED_INITIAL_LITERALS))) {
      node = timed_literal();
    } else if (jj_2_183(2)) {
      node = literal(Lexer.CONSTANT);
    } else if (jj_2_184(2) && (this.isRequirement(RequireKey.FLUENTS)
                            || this.isRequirement(RequireKey.NUMERIC_FLUENTS)
                            || this.isRequirement(RequireKey.OBJECT_FLUENTS)
                            || this.isRequirement(RequireKey.ACTION_COSTS))) {
      node = equal_init_el();
...
this.error(e, token.beginLine, token.beginColumn);
  ...
  final public Exp pref_con_gd() throws ParseException {Exp node = null;
    ...
    } else if (jj_2_186(2) && (this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS))) {
      node = forall_pref_con_gd();
    } else if (jj_2_187(2) && (this.isRequirement(RequireKey.PREFERENCES))) {
...
{if ("" != null) return node;}
  ...
  private boolean jj_3R_65()
 {
    ...
    jj_semLA = this.isRequirement(RequireKey.FLUENTS)
                        ...
                        || this.isRequirement(RequireKey.OBJECT_FLUENTS);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_48()) return true;
    }
    }
    }
    }
  ...
  private boolean jj_3R_135()
 {
    ...
    jj_semLA = this.isRequirement(RequireKey.FLUENTS)
                        ...
                        || this.isRequirement(RequireKey.OBJECT_FLUENTS);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_123()) return true;
    }
    }
    }
    }
  ...
  private boolean jj_3R_159()
 {
    ...
    jj_semLA = this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_186()) {
    jj_scanpos = xsp;
    jj_lookingAhead = true;
    jj_semLA = this.isRequirement(RequireKey.PREFERENCES);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_187()) {
    jj_scanpos = xsp;
  ...
  private boolean jj_3R_117()
 {
    ...
    jj_semLA = this.isRequirement(RequireKey.UNIVERSAL_PRECONDITIONS);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_111()) return true;
    }
    }
    return false;
  }
  ...
  private boolean jj_3R_153()
 {
    ...
    jj_semLA = this.isRequirement(RequireKey.FLUENTS)
                        ...
                        || this.isRequirement(RequireKey.ACTION_COSTS);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_184()) return true;
    }
    }
    return false;
  }
  ...
  private boolean jj_3R_105()
 {
    ...
    jj_semLA = this.isRequirement(RequireKey.DURATION_INEQUALITIES);
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3_106()) return true;
    }
    }
    return false;
  }
